                        ...
                        For x = 0 To fetched - 1
                            ...
                            If Not cancellationToken.IsCancellationRequested _
                                ...
                                If Not newItem Is Nothing Then
                                    ...
                                    Else If Shell.GetSpecialFolders().Where(Function(f) Shell.PrivilegedCloudProviders.Contains(f.Key)).Any(Function(f) newItem.FullPath.ToUpper().Equals(f.Value.FullPath.ToUpper())) Then _
                                        newItem.TreeSortPrefix = "_006_" & newItem.DisplayName _
