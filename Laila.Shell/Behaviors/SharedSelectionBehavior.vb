                ...
                Sub(s As Object, e As MouseButtonEventArgs)
                    If e.LeftButton = Input.MouseButtonState.Pressed AndAlso Not e.OriginalSource Is Nothing Then
                        ...
                        If _children.FirstOrDefault(Function(listBox) listBox.SelectedItems.Contains(clickedItem)) Is Nothing _
                            ...
                            If vs?.Visibility = Visibility.Visible AndAlso Not PresentationSource.FromVisual(vs) Is Nothing Then _
                                _ptMax.X = _listBox.PointFromScreen(vs.PointToScreen(New Point(0, 0))).X - 1
                            If hs?.Visibility = Visibility.Visible AndAlso Not PresentationSource.FromVisual(hs) Is Nothing Then _
