...
Public Interface IShellFolder
    ...
    <PreserveSig()>
    Function CreateViewObject(ByVal hwndOwner As IntPtr, ByRef riid As Guid, ByRef ppvOut As IntPtr) As Integer
    'IUnknown) As Integer
    ...
    <PreserveSig()>
    Function GetUIObjectOf(ByVal hwndOwner As IntPtr, ByVal cidl As Integer, <MarshalAs(UnmanagedType.LPArray, SizeParamIndex:=0)> ByVal apidl() As IntPtr, ByRef riid As Guid, ByRef prgfInOut As Integer, ByRef ppvOut As IntPtr) As Integer
