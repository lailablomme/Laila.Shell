...
Namespace Interop.Folders
    ...
    <ComImportAttribute(),
     InterfaceTypeAttribute(ComInterfaceType.InterfaceIsIUnknown),
     Guid("000214E6-0000-0000-C000-000000000046")>
    Public Interface IShellFolderForIExplorerCommandProvider
        <PreserveSig()>
        Function ParseDisplayName(ByVal hwndOwner As Integer, ByVal pbcReserved As IntPtr, <MarshalAs(UnmanagedType.LPWStr)> ByVal lpszDisplayName As String, ByRef pchEaten As Integer, ByRef ppidl As IntPtr, ByRef pdwAttributes As Integer) As Integer
        ...
        <PreserveSig()>
        Function CreateViewObject(ByVal hwndOwner As IntPtr, ByRef riid As Guid, <Out, MarshalAs(UnmanagedType.Interface)> ByRef ppvOut As IExplorerCommandProvider) As Integer

        <PreserveSig()>
        Function GetAttributesOf(ByVal cidl As Integer, <MarshalAs(UnmanagedType.LPArray, SizeParamIndex:=0)> ByVal apidl() As IntPtr, ByRef rgfInOut As Integer) As Integer

        <PreserveSig()>
        Function GetUIObjectOf(ByVal hwndOwner As IntPtr, ByVal cidl As Integer, <MarshalAs(UnmanagedType.LPArray, SizeParamIndex:=0)> ByVal apidl() As IntPtr, ByRef riid As Guid, ByRef prgfInOut As Integer, <Out, MarshalAs(UnmanagedType.Interface)> ByRef ppvOut As IExplorerCommandProvider) As Integer
