...
Namespace Interop.Items
    ...
    <InterfaceType(ComInterfaceType.InterfaceIsIUnknown)>
    <Guid("7E9FB0D3-919F-4307-AB2E-9B1860310C93")>
    Public Interface IShellItem2ForShellLink
        <PreserveSig>
        Function BindToHandler(<[In], MarshalAs(UnmanagedType.Interface)> pbc As IBindCtx, <[In]> ByRef rbhid As Guid, <[In]> ByRef riid As Guid, <Out, MarshalAs(UnmanagedType.Interface)> ByRef ppvOut As IShellLinkW) As Integer
