...
Public Class Shell
    ...
    Shared Sub New()
        ...
        _specialFolders.Add("Documents", Folder.FromParsingName("shell:::{d3162b92-9365-467a-956b-92703aca08af}", Nothing, Nothing, Nothing))
        _specialFolders.Add("Pictures", Folder.FromParsingName("shell:::{24ad3ad4-a569-4530-98e1-ab02f9417aa8}", Nothing, Nothing, Nothing))
        _specialFolders.Add("Downloads", Folder.FromParsingName("shell:::{088e3905-0323-4b02-9826-5d99428e115f}", Nothing, Nothing, Nothing))
        _specialFolders.Add("Videos", Folder.FromParsingName("shell:::{A0953C92-50DC-43bf-BE83-3742FED03C9C}", Nothing, Nothing, Nothing))
        _specialFolders.Add("Music", Folder.FromParsingName("shell:::{1CF1260C-4DD0-4ebb-811F-33C572699FDE}", Nothing, Nothing, Nothing))
        _specialFolders.Add("Favorites", Folder.FromParsingName("shell:::{323CA680-C24D-4099-B94D-446DD2D7249E}", Nothing, Nothing, Nothing))
    End Sub
    ...
    Public Shared ReadOnly Property Desktop As Folder
        Get
            If _desktop Is Nothing Then
                _desktop = Folder.FromKnownFolderGuid(Guids.KnownFolder_Desktop, Nothing, Nothing)
            End If
