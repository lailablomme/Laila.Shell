...
Public Class Pidl
    ...
    Public Shared Function GetItemsFromShellIDListArray(ptr As IntPtr) As List(Of Item)
        ...
        Else
            parentShellFolder = New Folder(Item.GetIShellItem2FromPidl(IntPtr.Add(start, offset), Nothing), Nothing, Nothing, 0)._shellFolder
        End If
        ...
        For i = 0 To count - 1
            ...
            result.Add(Item.FromParsingName(Item.GetFullPathFromShellItem2(shellItem2), Nothing, Nothing, 0))
        Next
