...
Public Class Pidl
    ...
    Public Shared Function GetItemsFromShellIDListArray(ptr As IntPtr) As List(Of Item)
        ...
        ' read count
        Dim count As UInt32 = Marshal.ReadInt32(ptr) : ptr = IntPtr.Add(ptr, Marshal.SizeOf(Of UInt32))

        ' read parent
        Dim offset As UInt32 = Marshal.ReadInt32(ptr) : ptr = IntPtr.Add(ptr, Marshal.SizeOf(Of UInt32)) ' parent
        Dim parentShellFolder As IShellFolder
        If Marshal.ReadInt16(IntPtr.Add(start, offset)) = 0 Then
        ...
        ' read items
        For i = 0 To count - 1
            offset = Marshal.ReadInt32(ptr) : ptr = IntPtr.Add(ptr, Marshal.SizeOf(Of UInt32))
