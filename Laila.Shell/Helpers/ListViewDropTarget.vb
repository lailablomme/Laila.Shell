        ...
        If Not _fileList Is Nothing Then
            ...
            AndAlso Not (_fileList.Count = 1 _
                ...
                OrElse CType(pdwEffect, DROPEFFECT).HasFlag(DROPEFFECT.DROPEFFECT_COPY) Then
                    Dim sourceItems As List(Of IShellItem) = _fileList.Select(Function(f) CType(Item.FromParsingName(f, Nothing, Nothing, Nothing)?._shellItem2, IShellItem)).Where(Function(i) Not i Is Nothing).ToList()
